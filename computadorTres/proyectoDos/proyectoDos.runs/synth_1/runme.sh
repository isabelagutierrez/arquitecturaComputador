...
HD_PWD='C:/Users/isabelagutierrez/Documents/computadorDos/proyectoDos/proyectoDos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divisorFrec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divisorFrec.tcl
