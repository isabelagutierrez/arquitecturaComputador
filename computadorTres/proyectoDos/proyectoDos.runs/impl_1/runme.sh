...
HD_PWD='C:/Users/isabelagutierrez/Documents/computadorDos/proyectoDos/proyectoDos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log divisorFrec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divisorFrec.tcl -notrace
